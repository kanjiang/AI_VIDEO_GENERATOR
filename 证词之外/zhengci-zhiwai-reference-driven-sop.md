...
1. `screenplay/证词之外/zhengci-zhiwai-screenplay.md`：主剧本
2. `screenplay/证词之外/zhengci-zhiwai-storyboard-beats.md`：分镜节拍
3. `screenplay/证词之外/zhengci-zhiwai-shot-list.md`：72 镜唯一顺序基准
4. `screenplay/证词之外/zhengci-zhiwai-final-generation-list.md`：当前生成顺序与测试包真源
5. `screenplay/证词之外/zhengci-zhiwai-seedance-reference-map.md`：逐镜参考图 alias 绑定
...
1. `screenplay/证词之外/zhengci-zhiwai-asset-prompts.md`：主资产生成提示词
2. `screenplay/证词之外/zhengci-zhiwai-asset-canvas.html`：资产看板与进度追踪
3. `screenplay/证词之外/zhengci-zhiwai-missing-assets.md`：当前 storyboard 缺图汇总
4. `screenplay/证词之外/zhengci-zhiwai-missing-assets-task-board.md`：缺图批次看板
5. `screenplay/证词之外/zhengci-zhiwai-asset-batch-supplement-03.md`：Batch A 直投包
6. `screenplay/证词之外/zhengci-zhiwai-asset-batch-supplement-04.md`：Batch B 直投包
7. `screenplay/证词之外/zhengci-zhiwai-asset-batch-supplement-05.md`：Batch C 直投包
...
3. `screenplay/证词之外/zhengci-zhiwai-navigation.md`：项目导航页
4. `screenplay/证词之外/zhengci-zhiwai-next-steps.md`：当前最优先执行清单
...
2. `screenplay/证词之外/zhengci-zhiwai-asset-batch-01.md`
3. `screenplay/证词之外/zhengci-zhiwai-asset-batch-03.md`
4. `screenplay/证词之外/zhengci-zhiwai-asset-canvas.html`
...
1. `screenplay/证词之外/zhengci-zhiwai-test-pack-storyboard-prompts.md`
...
5. `screenplay/证词之外/zhengci-zhiwai-act3-video-prompts-shot-by-shot.md`
6. `screenplay/证词之外/zhengci-zhiwai-act1-video-prompts.md`
7. `screenplay/证词之外/zhengci-zhiwai-act2-video-prompts.md`
8. `screenplay/证词之外/zhengci-zhiwai-act3-video-prompts.md`
...
1. Batch A：`screenplay/证词之外/zhengci-zhiwai-asset-batch-supplement-03.md`
2. Batch B：`screenplay/证词之外/zhengci-zhiwai-asset-batch-supplement-04.md`
3. Batch C：`screenplay/证词之外/zhengci-zhiwai-asset-batch-supplement-05.md`
...
5. 再看 `screenplay/证词之外/zhengci-zhiwai-asset-canvas.html` 的进度是否上升
